...
class Exprience extends Component {
  constructor(props) {
    ...
    this.addResp1 = this.addResp1.bind(this);
  ...
  addResp() {
    this.setState({ respArr: [...this.state.respArr,this.state.responsibilties] ,responsibilties:''}, () =>
      this.props.getExp(this.state)
    );
  }
  addResp1() {
    this.setState({ respArr1: [...this.state.respArr1,this.state.responsibilties1] ,responsibilties1:''}, () =>
      this.props.getExp(this.state)
    );
  }
  render() {
      ...
      <div className="PanelGI">
        ...
        >
          ...
          <div className="fname">
            ...
            />
            <button onClick={this.addResp}>Add Responsibility</button>
          </div>
          {/* {this.state.number === "1" && (
            <input type="submit" value="Add Another Experience" />
          )} */}
        </form>
        {this.state.number === "2" && this.state.showingForm && (
          ...
          >
            ...
            <div className="fname">
              ...
              <input
                ...
                placeholder="Manage Junior Developers-Handle Tasks-Follow up with bugs"
              />
              <button onClick={this.addResp1}>Add Responsibility</button>
            </div>
